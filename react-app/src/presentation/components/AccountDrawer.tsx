...
const AccountDrawer: React.FC = () => {
    ...
    // Fetch recommendations whenever favorites change
    useEffect(() => {
        ...
        const fetchRecommendations = async () => {
            ...
            try {
                ...
                setRecommendations((res.data.recommendations || []).slice(0, 5));
            } catch (err) {
    ...
    const handleRemoveFavorite = async (vkmId: number) => {
        try {
            ...
            setUserData(prev => ({ ...prev, favorites: mappedFavorites }));
        ...
        <div className="favorites-card">
            ...
            {loading ? (
                ...
                <div className="favorites-list">
                  ...
                  <span onClick={() => navigate(`/vkms/${fav.id}`)}>
                    {fav.name}
                  </span>
            ...
            {loadingRecs ? (
                ...
                <div className="recommendations-column-container">
                    {recommendations.map((rec) => {
                        ...
                        return (
                            <div key={rec.id} className="terminal-recommendation-item">
                                ...
                                >
                                    <div className="header-info">
                                        <h4 className="m-0" onClick={(e) => {
                                            ...
                                            navigate(`/vkms/${rec.id}`);
                                        }} style={{ cursor: 'pointer', textDecoration: 'underline' }}>
                                            {rec.name}
                                        </h4>
                                        <span className="match-score">{rec.score}% match</span>
                                    </div>
