            ...
            <div className="account-flex-container">
                ...
                <div className="favorites-card">
                    ...
                    <Fade in={showFavoritesMessage} mountOnEnter unmountOnExit>
                        <div>
                            {favoritesMessage && (
                                <Alert variant={favoritesMessage.type}>
                    ...
                    {loading ? (
                        ...
                        <p className="text-white mt-3">
                            Hier komen je favorieten te staan.
                        </p>
                    ) : (
                                    ...
                                    <div className="xai-body" style={{maxWidth: "700px"}}>
                                        ...
                                        <div className="xai-score-explanations mb-3">
                                            <div className="xai-score-item">
                                                <strong>90% en hoger:</strong> Sterke match met jouw
                                                interesses, sterk aanbevolen.
                                            </div>
                                            <div className="xai-score-item">
                                                <strong>75–90%:</strong> Overwegend matchend, maar het
                                                kan nuttig zijn eerst wat extra te onderzoeken.
                                            </div>
                                            <div className="xai-score-item">
                                                <strong>50–75%:</strong> Gedeeltelijk vergelijkbaar;
                                                bespreek dit bij voorkeur eerst met een studiecoach.
                                            </div>
                                            <div className="xai-score-item">
                                                <strong>Onder 50%:</strong> Niet aanbevolen om te
                                                kiezen.
                                            </div>
                                        </div>
                                        ...
                                        <div className="xai-section">
                                            ...
                                            <p>
                                                Vergelijkt de inhoud van VKM’s met jouw favorieten.
                                                Modules met vergelijkbare onderwerpen scoren hoger.
                                            </p>
                                        </div>
                                        ...
                                        <div className="xai-section">
                                            ...
                                            <p>
                                                Houdt rekening met jouw studiegedrag, voorkeuren en
                                                eerdere keuzes. Dit is de zwaarst meewegende factor.
                                            </p>
                                        </div>
                                        ...
                                        <div className="xai-section">
                                            ...
                                            <p>
                                                Modules die vaker door andere studenten gekozen worden,
                                                krijgen een lichte voorkeur.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                return (
                                    <div key={rec._id} className="terminal-recommendation-item">
                                        ...
                                        <div
                                            ...
                                            onClick={() =>
                                                setExpandedRec(isExpanded ? null : rec._id)
                                            }
                                        >
